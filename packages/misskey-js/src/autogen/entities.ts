...
// export type NotesKigurumiTimelineRequest = operations['notes/kigurumi-timeline']['requestBody']['content']['application/json'];
// export type NotesKigurumiTimelineResponse = operations['notes/kigurumi-timeline']['responses']['200']['content']['application/json'];
